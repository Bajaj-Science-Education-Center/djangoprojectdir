class BallData {
  ...
  manageControlPanel() {
    ...
    this.velXvalue.innerHTML = Number(this.velXslider.value)/10;
    this.velYvalue.innerHTML = Number(this.velYslider.value)/10;
  ...
  updateConstants(ball) {
    ...
    ball.vel.x = Number(this.velXslider.value)/(ts*10);
    ball.vel.y = Number(this.velYslider.value)/-(ts*10);
